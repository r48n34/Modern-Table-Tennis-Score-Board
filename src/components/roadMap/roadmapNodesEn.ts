...
export const roadMapNodesEn = [
    ...
    },
    {
        ...
        data: { label: "Serve And Attack (First 3)" },
        style: {
            width: 260,
        },
        sourcePosition: Position.Right,
    ...
    },
    {
        ...
        data: { label: "Identify Opponents Serve (Top / Side / Back)" },
        style: {
            width: 260,
        },
        sourcePosition: Position.Right,
    ...
    },
    {
        ...
        data: { label: "Random Position Attack & Defence" },
        style: {
            width: 260,
        },
        sourcePosition: Position.Right,
    ...
    },
    {
        ...
        data: { label: "Defence And Blocking" },
        style: {
            width: 260,
        },
        sourcePosition: Position.Right,
...

    {
        ...
        data: { label: "Advance Skills" },
    },
    {
        id: "Advance-Skills-Backhand-Drive",
        position: { x: 300, y: 1400 },
        data: { label: "Backhand (Counter) Drive (Back Spin)" },
        style: {
            width: 260,
        },
        sourcePosition: Position.Right,
    ...
    },
    {
        ...
        data: { label: "Fronthand (Counter) Drive Semi-Long (Back Spin)" },
        style: {
            width: 260,
        },
        sourcePosition: Position.Right,
    ...
    },
    {
        ...
        data: { label: "Backhand Flick (Side Flick)" },
        style: {
            width: 260,
        },
        sourcePosition: Position.Right,
    ...
    {
        id: "Advance-Skills-Fronthand-Flick",
        position: { x: 600, y: 1460 },
        data: { label: "Fronthand Flick (Side Flick)" },
        style: {
            width: 260,
        },
        sourcePosition: Position.Right,
